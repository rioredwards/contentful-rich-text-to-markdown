...
var require_rich_text_html_renderer_es5 = __commonJS({
  "node_modules/@contentful/rich-text-html-renderer/dist/rich-text-html-renderer.es5.js"(exports) {
    ...
    var schemaConstraints = createCommonjsModule(function (module3, exports2) {
      ...
      exports2.CONTAINERS =
        ((_a2 = {}),
        (_a2[blocks.BLOCKS.OL_LIST] = [blocks.BLOCKS.LIST_ITEM]),
        (_a2[blocks.BLOCKS.UL_LIST] = [blocks.BLOCKS.LIST_ITEM]),
        (_a2[blocks.BLOCKS.LIST_ITEM] = exports2.LIST_ITEM_BLOCKS),
        (_a2[blocks.BLOCKS.QUOTE] = [blocks.BLOCKS.PARAGRAPH]),
        (_a2[blocks.BLOCKS.TABLE] = [blocks.BLOCKS.TABLE_ROW]),
        (_a2[blocks.BLOCKS.TABLE_ROW] = [
          blocks.BLOCKS.TABLE_CELL,
          blocks.BLOCKS.TABLE_HEADER_CELL,
        ]),
        (_a2[blocks.BLOCKS.TABLE_CELL] = [blocks.BLOCKS.PARAGRAPH]),
        (_a2[blocks.BLOCKS.TABLE_HEADER_CELL] = [blocks.BLOCKS.PARAGRAPH]),
        _a2);
      exports2.HEADINGS = [
        blocks.BLOCKS.HEADING_1,
        blocks.BLOCKS.HEADING_2,
    ...
    var dist = createCommonjsModule(function (module3, exports2) {
      ...
      exports2.helpers =
        ...
        exports2.BLOCKS =
          void 0;
      Object.defineProperty(exports2, "BLOCKS", {
        enumerable: true,
        get: function () {
          return blocks.BLOCKS;
        },
      });
      Object.defineProperty(exports2, "INLINES", {
        enumerable: true,
        get: function () {
          return inlines.INLINES;
        },
      });
      Object.defineProperty(exports2, "MARKS", {
        enumerable: true,
        get: function () {
      ...
      Object.defineProperty(exports2, "EMPTY_DOCUMENT", {
        enumerable: true,
        get: function () {
    ...
    function nodeListToHtmlString(nodes, _a2) {
      var renderNode = _a2.renderNode,
        renderMark = _a2.renderMark,
        preserveWhitespace = _a2.preserveWhitespace;
      return nodes
        .map(function (node) {
...
var require_translator = __commonJS({
  "node_modules/node-html-markdown/dist/translator.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createTranslatorContext =
      exports.isTranslatorConfig =
      exports.TranslatorCollection =
      exports.PostProcessResult =
        void 0;
          ...
          get: function () {
            ...
            return Object.keys(this.attribs).map(function (name) {
              ...
              return {
                ...
                namespace:
                  (_a = _this["x-attribsNamespace"]) === null || _a === void 0 ? void 0 : _a[name],
                prefix:
                  (_b = _this["x-attribsPrefix"]) === null || _b === void 0 ? void 0 : _b[name],
              };
            });
          },
          enumerable: false,
...
var require_lib4 = __commonJS({
  "node_modules/dom-serializer/lib/index.js"(exports) {
      ...
      return Object.keys(attributes)
        .map(function (key) {
          ...
          if (opts.xmlMode === "foreign") {
            key =
              (_b = foreignNames_js_1.attributeNames.get(key)) !== null && _b !== void 0 ? _b : key;
          }
    ...
    function renderTag(elem, opts) {
      ...
      if (opts.xmlMode === "foreign") {
        elem.name =
          (_a = foreignNames_js_1.elementNames.get(elem.name)) !== null && _a !== void 0
            ? _a
            : elem.name;
    ...
    function renderText(elem, opts) {
      ...
      var data = elem.data || "";
      if (
        ((_a = opts.encodeEntities) !== null && _a !== void 0 ? _a : opts.decodeEntities) !==
          false &&
  ...
  "node_modules/domutils/lib/querying.js"(exports) {
    ...
    function existsOne(test, nodes) {
      return nodes.some(function (checked) {
        return (
          (0, domhandler_1.isTag)(checked) && (test(checked) || existsOne(test, checked.children))
        );
      });
    }
  ...
  "node_modules/domutils/lib/feeds.js"(exports) {
    ...
    function getRssFeed(feedRoot) {
      ...
      var feed = {
        ...
        id: "",
        items: (0, legacy_js_1.getElementsByTagName)("item", feedRoot.children).map(function (
          item
        ) {
          var children = item.children;
          var entry = { media: getMediaElements(children) };
            ...
            if (selector.charCodeAt(selectorIndex) === 40) {
              if (unpackPseudos.has(name_2)) {
                ...
                if (selector.charCodeAt(selectorIndex) !== 41) {
                  throw new Error(
                    "Missing closing parenthesis in :".concat(name_2, " (").concat(selector, ")")
                  );
                }
                selectorIndex += 1;
              } else {
  ...
  "node_modules/css-what/lib/commonjs/stringify.js"(exports) {
    ...
    function stringifyToken(token, index, arr) {
      switch (token.type) {
        ...
        case types_1.SelectorType.Universal:
          return token.namespace === "*" && index + 1 < arr.length && "name" in arr[index + 1]
            ? ""
        ...
        case types_1.SelectorType.Attribute: {
          ...
          return "["
            ...
            .concat(token.ignoreCase === null ? "" : token.ignoreCase ? " i" : " s", "]");
        }
      }
    }
    ...
    function getNamespace(namespace) {
      return namespace !== null
        ? "".concat(namespace === "*" ? "*" : escapeName(namespace, charsToEscapeInName), "|")
        : "";
    }
        ...
        if (context && compiled !== boolbase_1.default.trueFunc) {
          ...
          return function (elem) {
            ...
            var nextElements = shouldTestNextSiblings_1
              ? __spreadArray(__spreadArray([], childs, true), getNextSiblings(elem, adapter), true)
              : childs;
...
var require_matcher = __commonJS({
  "node_modules/node-html-parser/dist/matcher.js"(exports) {
    ...
    function findOne(test, elems) {
      var elem = null;
      for (
        var i = 0, l = elems === null || elems === void 0 ? void 0 : elems.length;
        i < l && !elem;
        i++
      ) {
        var el = elems[i];
      ...
      (function () {
        ...
        VoidTag2.prototype.formatNode = function (tag, attrs, innerHTML) {
          ...
          return this.isVoidElement(tag.toLowerCase())
            ...
            : "<".concat(tag).concat(attrs, ">").concat(innerHTML, "</").concat(tag, ">");
        };
  ...
  "node_modules/node-html-parser/dist/nodes/html.js"(exports) {
      ...
      (function (_super) {
        ...
        HTMLElement2.prototype.replaceWith = function () {
          ...
          parent.childNodes = __spreadArray(
            __spreadArray(
              __spreadArray([], parent.childNodes.slice(0, idx), true),
    ...
    function base_parse(data, options) {
      ...
      var voidTag = new void_tag_1.default(
        (_a = options === null || options === void 0 ? void 0 : options.voidTag) === null ||
        _a === void 0
          ? void 0
          : _a.closingSlash,
        (_b = options === null || options === void 0 ? void 0 : options.voidTag) === null ||
        _b === void 0
          ? void 0
          : _b.tags
      );
      ...
      while ((match = kMarkupPattern.exec(data))) {
        ...
        if (lastTextPos > -1) {
          if (lastTextPos + matchLength < tagEndPos) {
            ...
            currentParent.appendChild(
              new text_1.default(text, currentParent, createRange(lastTextPos, tagStartPos))
            );
          }
        }
        ...
        if (matchText[1] === "!") {
          if (options.comment) {
            ...
            currentParent.appendChild(
              new comment_1.default(text, currentParent, createRange(tagStartPos, tagEndPos))
            );
          }
          continue;
        }
          ...
          if (is_block_text_element(tagName)) {
            ...
            if (element_should_be_ignore(tagName)) {
              ...
              if (text.length > 0 && /\S/.test(text)) {
                currentParent.appendChild(
                  new text_1.default(text, currentParent, createRange(tagEndPos_1, textEndPos))
                );
              }
            }
            if (closeIndex === -1) {
...
var require_utilities = __commonJS({
  "node_modules/node-html-markdown/dist/utilities.js"(exports) {
    ...
    exports.perfStop =
      exports.perfStart =
      exports.getChildNodes =
      exports.parseHTML =
      exports.truthyStr =
      exports.getTrailingWhitespaceInfo =
      exports.tagSurround =
      exports.splitSpecial =
      exports.isWhiteSpaceOnly =
      exports.surround =
      exports.trimNewLines =
        void 0;
    ...
    function tryParseWithNativeDom(html) {
      try {
        if (
          !(
            (window === null || window === void 0 ? void 0 : window.DOMParser) &&
    ...
    function parseHTML(html, options) {
      ...
      if (!el) el = nodeHtmlParse(html, config_1.nodeHtmlParserConfig);
      perfStop("parse");
      return el;
    }
...
`,
      ...
      "strong,b": {
        ...
        postprocess: ({ content, options: { strongDelimiter } }) =>
          (0, utilities_1.isWhiteSpaceOnly)(content)
      ...
      li: ({ options: { bulletMarker }, indentLevel, listKind, listItemNumber }) => {
        ...
        return {
          prefix:
            ...
            (listKind === "OL" && listItemNumber !== void 0
              ? `${listItemNumber}. `
              : `${bulletMarker} `),
...
${"   ".repeat(indentationLevel)}`
      ...
      blockquote: {
        postprocess: ({ content }) =>
          (0, utilities_1.trimNewLines)(content).replace(/^(>*)[^\S\r\n]?/gm, `>$1 `),
      },
      /* Code (block / inline) */
      code: ({ node, parent, options: { codeFence, codeBlockStyle }, visitor }) => {
        var _a, _b;
        const isCodeBlock =
          ["PRE", "WRAPPED-PRE"].includes(
            parent === null || parent === void 0 ? void 0 : parent.tagName
          ...
          return {
            ...
            postprocess: ({ content }) => {
              ...
              const delimiter =
                "`" +
                (((_b2 =
                  (_a2 = content.match(/`+/g)) === null || _a2 === void 0
                    ? void 0
                    : _a2.sort((a, b) => b.length - a.length)) === null || _b2 === void 0
                  ? void 0
                  : _b2[0]) || "");
              const padding = delimiter.length > 1 ? " " : "";
              return (0, utilities_1.surround)(
                (0, utilities_1.surround)(content, padding),
                delimiter
              );
            },
          };
        if (codeBlockStyle === "fenced") {
          const language =
            ((_b =
              (_a = node.getAttribute("class")) === null || _a === void 0
                ? void 0
                : _a.match(/language-(\S+)/)) === null || _b === void 0
              ? void 0
              : _b[1]) || "";
          return {
            noEscape: true,
      ...
      table: ({ visitor }) => ({
        ...
        postprocess: ({ content, nodeMetadata, node }) => {
          const rawRows = (0, utilities_1.splitSpecial)(content).map(({ text }) =>
          ...
          if (rows.length < 1) return translator_1.PostProcessResult.RemoveNode;
    ...
    exports.tableTranslatorConfig = {
      ...
      tr: ({ visitor }) => ({
        ...
        prefix: "| ",
        postprocess: ({ content }) =>
          !/ \|\s*$/.test(content) ? translator_1.PostProcessResult.RemoveNode : content,
      }),
      ...
      "th,td": ({ visitor }) => ({
        ...
        postfix: " |",
        postprocess: ({ content }) =>
          (0, utilities_1.trimNewLines)(content)
            .replace("|", "\\|")
            .replace(/(?:\r?\n)+/g, " ")
            .trim(),
      }),
...
var require_nodes = __commonJS({
  "node_modules/node-html-markdown/dist/nodes.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isElementNode =
      exports.isCommentNode =
      exports.isTextNode =
      exports.CommentNode =
      exports.NodeType =
        void 0;
  ...
  "node_modules/node-html-markdown/dist/visitor.js"(exports) {
    ...
    var Visitor = class {
      ...
      appendResult(s, startPos, spaceIfRepeatingChar) {
        if (!s && startPos === void 0) return;
        const { result } = this;
        if (startPos !== void 0) result.text = result.text.substr(0, startPos);
      ...
      optimizeTree(node) {
        ...
        (function visit(node2) {
          let res = false;
          if (
            (0, nodes_1.isTextNode)(node2) ||
            ((0, nodes_1.isElementNode)(node2) &&
              config_1.contentlessElements.includes(node2.tagName))
          ) {
            res = true;
          } else {
            ...
            if (!childNodes.length) {
              ...
              if (
                (translator === null || translator === void 0
                  ? void 0
                  : translator.preserveIfEmpty) ||
      ...
      processText(text, metadata) {
        ...
        if (!(metadata === null || metadata === void 0 ? void 0 : metadata.preserveWhitespace))
          res = res.replace(/\s+/g, " ");
        if (metadata === null || metadata === void 0 ? void 0 : metadata.noEscape) return res;
        ...
        if (textReplace) for (const [pattern, r] of textReplace) res = res.replace(pattern, r);
        return res;
      }
      visitNode(node, textOnly, metadata) {
        ...
        if ((0, nodes_1.isTextNode)(node)) {
          if (node.wholeText) {
            ...
            (_b = (_f = node).trimmedText) !== null && _b !== void 0
              ? _b
              : (_f.trimmedText = (0, utilities_1.trimNewLines)(node.wholeText));
          }
          return node.isWhitespace &&
            !(metadata === null || metadata === void 0 ? void 0 : metadata.preserveWhitespace)
        ...
        if (textOnly || !(0, nodes_1.isElementNode)(node)) return;
        const translatorCfgOrFactory = (
          metadata === null || metadata === void 0 ? void 0 : metadata.translators
        )
        ...
        switch (node.tagName) {
          ...
          case "OL":
            metadata = Object.assign(Object.assign({}, metadata), {
              ...
              indentLevel:
                ((_c = metadata === null || metadata === void 0 ? void 0 : metadata.indentLevel) !==
                  null && _c !== void 0
                  ? _c
                  : -1) + 1,
            });
          ...
          case "LI":
            if ((metadata === null || metadata === void 0 ? void 0 : metadata.listKind) === "OL")
              metadata.listItemNumber =
                ((_d = metadata.listItemNumber) !== null && _d !== void 0 ? _d : 0) + 1;
            break;
          case "PRE":
        ...
        if (!(0, translator_1.isTranslatorConfig)(translatorCfgOrFactory)) {
          ctx = (0, translator_1.createTranslatorContext)(
            this,
            node,
            metadata,
          ...
          cfg = Object.assign(
            Object.assign({}, translatorCfgOrFactory.base),
            translatorCfgOrFactory(ctx)
          );
        } else cfg = translatorCfgOrFactory;
        if (cfg.ignore) return;
        if (
          cfg.noEscape &&
          !(metadata === null || metadata === void 0 ? void 0 : metadata.noEscape)
        ) {
        ...
        if (
          ...
          metadata = Object.assign(Object.assign({}, metadata), {
            translators: cfg.childTranslators,
          });
          this.nodeMetadata.set(node, metadata);
        }
        ...
        if (typeof cfg.content === "string")
          ...
          if (cfg.postprocess) {
            ...
            if (postRes === translator_1.PostProcessResult.RemoveNode) {
              if (
                node.tagName === "LI" &&
                (metadata === null || metadata === void 0 ? void 0 : metadata.listItemNumber)
              )
                --metadata.listItemNumber;
    ...
    var NodeHtmlMarkdown2 = class _NodeHtmlMarkdown {
      constructor(options, customTranslators, customCodeBlockTranslators) {
        ...
        const ignoredElements =
          (_b =
            (_a = this.options.ignore) === null || _a === void 0
              ? void 0
              : _a.concat(config_1.defaultIgnoreElements)) !== null && _b !== void 0
            ? _b
            : config_1.defaultIgnoreElements;
        const blockElements =
          (_d =
            (_c = this.options.blockElements) === null || _c === void 0
              ? void 0
              : _c.concat(config_1.defaultBlockElements)) !== null && _d !== void 0
            ? _d
            : config_1.defaultBlockElements;
        ...
        blockElements === null || blockElements === void 0
          ? void 0
        ...
        for (const [elems, cfg] of Object.entries(
          Object.assign(Object.assign({}, config_1.defaultTranslators), customTranslators)
        ))
          this.translators.set(elems, cfg, true);
        for (const [elems, cfg] of Object.entries(
          Object.assign(
            Object.assign({}, config_1.defaultCodeBlockTranslators),
            customCodeBlockTranslators
          )
        ))
      ...
      static translate(htmlOrFiles, opt, customTranslators, customCodeBlockTranslators) {
        return _NodeHtmlMarkdown.prototype.translateWorker.call(
          new _NodeHtmlMarkdown(opt, customTranslators, customCodeBlockTranslators),
          htmlOrFiles
        );
      }
      ...
      translateWorker(htmlOrFiles) {
        ...
        for (const [fileName, html] of Object.entries(inputFiles)) {
          ...
          outputFiles[fileName] = (0, visitor_1.getMarkdownForHtmlNodes)(
            this,
            parsedHtml,
            fileName !== "default" ? fileName : void 0
          );
        }
...
__export(src_exports, {
  convertRichTextToMarkdown: () => convertRichTextToMarkdown,
});
...
var customTranslatorConfigForCodeBlock = {
  CustomCodeBlock: {
...
function convertRichTextToMarkdown(document2) {
  const html = (0, import_rich_text_html_renderer.documentToHtmlString)(
    document2,
    htmRendererOptions
  );
  const markdown = import_node_html_markdown.NodeHtmlMarkdown.translate(
    html,
    {},
    customTranslatorConfigForCodeBlock
  );
  return markdown;
}
