...
function convertRichTextToMarkdown(document2) {
  const html = (0, import_rich_text_html_renderer.documentToHtmlString)(document2, htmRendererOptions);
  const markdown = import_node_html_markdown.NodeHtmlMarkdown.translate(html, {}, customTranslatorConfigForCodeBlock);
  return markdown;
}
